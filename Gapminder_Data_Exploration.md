...
![](Gapminder_Data_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-4-1.png)
...
![](Gapminder_Data_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-6-1.png)
...
![](Gapminder_Data_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-7-1.png)
...
![](Gapminder_Data_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-8-1.png)
...
![](Gapminder_Data_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-9-1.png)

``` r
plot(log(gdpPercap) ~ log(pop), gapminder)
```

![](Gapminder_Data_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-9-2.png)

``` r
plot(lifeExp ~ continent, gapminder)
```

![](Gapminder_Data_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-9-3.png)

``` r
plot(lifeExp ~ country, gapminder)
```

![](Gapminder_Data_Exploration_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-9-4.png)
